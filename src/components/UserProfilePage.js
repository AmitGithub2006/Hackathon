    ...
    const fetchUserDetails = async () => {
      try {
        ...
        if (response.ok) {
          ...
          const secondApiResponse = await fetch(`https://merd-api.merakilearn.org/user/news_app/${userId}`);
  ...
  return (
    <div className="user-profile-page">
              ...
              <div className="card">
                <div className="card-body">
                  ...
                  <h5 className="card-text">
                    Read your favourite articles here!
                  </h5>
                </div>
              </div>
            </div>
      ...
      <footer className="footer">
        <div className="container">
          <p className="text-muted">&copy; 2023 BBC News. All rights reserved.</p>
        </div>
      </footer>
    </div>
  );
