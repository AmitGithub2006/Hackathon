    ...
    try {
      ...
      if (response.ok) {
        ...
        try {
          ...
          const secondApiResponse = await fetch('https://merd-api.merakilearn.org/user/news_app/login', {
            method: 'POST',
            headers: {
              'Content-Type': 'application/json',
            },
  ...
  return (
    <div className="login-page">
      <header className="header">
        <h1 className="text-center text-white">BBC NEWS</h1>
      </header>
      ...
      <footer className="footer">
        <p className="text-center text-white">© 2023 BBC News. All rights reserved.</p>
      </footer>
    </div>
  );
};
